    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coefficients_category', to='shop.category', verbose_name='category')),
                ('holding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coefficients_holding', to='customer.holding', verbose_name='holdind')),
            ],
            options={
